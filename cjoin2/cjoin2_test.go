...
func TestCjoin2StdInput(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			inputStdin: "0000000 浜地______ 50 F 91 59 20 76 54\n0000001 鈴田______ 50 F 46 39 8 5 210000004 白土______ 40 M 58 71 20 10 6\n0000003 杉山______ 26 F 30 50 71 36 30\n0000005 崎村______ 50 F 82 79 16 21 80\n",
			want:       "0000000 * 浜地______ 50 F 91 59 20 76 54\n0000001 B 鈴田______ 50 F 46 39 8 5 210000004 A 白土______ 40 M 58 71 20 10 6\n0000003 * 杉山______ 26 F 30 50 71 36 30\n0000005 * 崎村______ 50 F 82 79 16 21 80\n",
		},
	}
	for _, c := range cases {
		outStream.Reset()
...
func TestCjoin2FileInputNgOutput(t *testing.T) {
	outStream, errStream, inStream := new(bytes.Buffer), new(bytes.Buffer), new(bytes.Buffer)
